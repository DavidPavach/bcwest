...
export default function LogoutPage() {
	...
	return (
		<div className="flex justify-center items-center py-10">
			<div className="bg-card shadow p-4 md:p-6 xl:p-8 border border-border/60 w-full max-w-xl">
				<div className="flex flex-col items-center text-center">
					<div className="flex justify-center items-center bg-destructive/10 mb-5 size-12 md:size-14 xl:size-16">
						<LogoutCurve
							variant="Bulk"
				...
				<div className="flex sm:flex-row flex-col gap-3 mt-8">
					...
					<Button
						...
						className="flex-1 bg-destructive hover:bg-destructive/90 h-12 font-semibold text-destructive-foreground"
					>
