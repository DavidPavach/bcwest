    ...
    return (
        <main className="bg-background p-8 border border-border">
            ...
            <header className="flex sm:flex-row flex-col sm:justify-between sm:items-start gap-y-5 sm:gap-y-0 pb-3">
                ...
                <div className="text-[11px] text-primary sm:text-right leading-relaxed">
                    <p>Invoice</p>
            ...
            {/* Billing Section */}
            <section className="grid grid-cols-1 md:grid-cols-[2fr_1fr] border border-border text-sm">
                {/* Billing Details */}
                ...
                <div className="flex sm:flex-row flex-col">
                    ...
                    <div className="flex-1 p-4 border-border sm:border-r border-b sm:border-b-0">
                        ...
                        <p className="mt-3 font-display font-bold text-primary text-xl">
                ...
                <>
                    ...
                    <section className="my-6">
                        <div className="flex items-center gap-x-2">
                            <h6 className="text-muted-foreground text-xs uppercase tracking-wider shrink-0">
                                Service Charge
                            </h6>
                    ...
                    <section className="bg-primary/20 p-4 border border-primary/50">
                        ...
                        <p className="mt-2 sm:max-w-4/5 text-muted-foreground text-sm">
                        ...
                        <div className="flex md:flex-row flex-col bg-background mt-4 border border-border">
                            {serviceCharge.map(([key, value], index) => (
                                <div key={key} className={`flex-1 p-4 ${index !== serviceCharge.length - 1
                                    ...
                                    <p className="mt-2 font-display font-semibold text-xl wrap-break-word">
                                        {value}
                                    </p>
                                </div>
                            ))}
            ...
            <section className="flex md:flex-row flex-col md:justify-between gap-y-5 md:gap-y-0">
                <div className="p-2 md:p-3 xl:p-4 border border-border md:w-[48%] text-[11px] text-sm">
            ...
            <section className="p-4 border border-border text-xs">
            ...
            {/* Disclaimer */}
            <div className="pt-4 border-border border-t text-[10px] text-muted-foreground xl:text-center leading-relaxed">
                This Invoice was{" "}
