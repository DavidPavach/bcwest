...
const TSRPdf = ({ tsr }: { tsr: TSR }) => {
    return (
        <main className="bg-background p-8 border border-border">
            ...
            <section className="gap-3 grid grid-cols-2 mb-3 pt-3 border-border border-t">
                <div>
                    <header className="mb-1 font-bold text-xs uppercase tracking-wide">
                        VERIFICATION
                    </header>

                    <div className="flex items-center gap-x-2">
                        <img src="/tsr_qr.png" alt="TSR QR Code" className="size-14" />
