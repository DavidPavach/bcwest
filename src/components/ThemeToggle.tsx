...
export const ThemeToggle = () => {
	...
	return (
		<button
			type="button"
			onClick={toggle}
			className="group inline-flex relative justify-center items-center bg-background hover:bg-accent border border-border hover:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 size-8 md:size-9 xl:size-10 transition-all duration-200 cursor-pointer"
